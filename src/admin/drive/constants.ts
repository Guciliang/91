				...
				return [
					{
						...
						options: [
							{ value: ONEDRIVE_AUTH_MODE_OPENLIST_API, label: "OpenList API" },
							{ value: ONEDRIVE_AUTH_MODE_CUSTOM_APP, label: "自建应用" },
						],
					},
					{
						key: "client_id",
						...
						visibleWhen: { key: "auth_mode", value: ONEDRIVE_AUTH_MODE_CUSTOM_APP },
					},
					{
						key: "client_secret",
						label: "客户端密钥",
